...
namespace UserService.Service.Services
{
    public class UserService : IUserService
    {
        ...
        private readonly IConfiguration _configuration;  // Khai báo _configuration

        public UserService(IUserRepository userRepo, IConfiguration configuration)
        {
            _userRepo = userRepo;
            _configuration = configuration;  // Gán _configuration
        }
        ...
        // Đăng ký người dùng mới, mặc định vai trò là "User" nếu không truyền
        ...
        public async Task<LoginResponseDTO?> LoginAsync(LoginDto loginDto)
        {
            ...
            var assertedToken = jwtTokenHandler.WriteToken(securityToken);  // Tạo token hợp lệ
